...
import { Home, Users, BarChart3, Monitor, Award, Lightbulb, Bell, ArrowRight, Menu, X } from 'lucide-react'
...
const Sidebar = ({ isOpen, onClose, isMobile = false }) => {
  const menuItems = [
    ...
    { icon: Users, label: "Teacher Bandwidth Tracker", active: false },
    { icon: BarChart3, label: "Performance Dashboard", active: false },
    { icon: Monitor, label: "Integrated LMS", active: false },
    { icon: Award, label: "Recognition & Rewards System", active: false },
    { icon: Lightbulb, label: "AI-Powered Insights", active: false },
  ]
      ...
      {menuItems.map((item, index) => (
        <div
          ...
          style={{
            ...
            color: item.active ? "#1f2937" : "#64748b",
            transition: "all 0.2s ease",
          }}
          onMouseEnter={(e) => {
            if (!item.active) {

...
const RecognitionDashboard = ({ onNavigate }) => {
          ...
          {sidebarItems.map((item, index) => (
            <div
              ...
              style={{
                ...
                gap: "12px",
                cursor: "pointer",
                backgroundColor: item.page === "recognition" ? "#eff6ff" : "transparent",
                borderRight: item.page === "recognition" ? "3px solid #3b82f6" : "none",
                color: item.page === "recognition" ? "#1d4ed8" : "#4b5563",
                fontWeight: item.page === "recognition" ? "500" : "400",
              }}

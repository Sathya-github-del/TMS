        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12 10C10.895 10 10 10.895 10 12C10 13.105 10.895 14 12 14C13.105 14 14 13.105 14 12C14 10.895 13.105 10 12 10Z" fill="#4f46e5"/>
            </svg>
          </div>
          <h1 style={{
            fontSize: '1.75rem',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: '600' }}>Teacher@123</div>
            </div>
          </div>
        </div>
      </div>
